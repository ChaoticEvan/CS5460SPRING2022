...
_testexit:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  24:	6a ff                	push   $0xffffffff
  26:	e8 3e 03 00 00       	call   369 <exit2>
  }
  else
  {
    wait2(&exit_status);
  2b:	83 ec 0c             	sub    $0xc,%esp
  2e:	8d 45 f4             	lea    -0xc(%ebp),%eax
  31:	50                   	push   %eax
  32:	e8 3a 03 00 00       	call   371 <wait2>
  }
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb ad 07 00 00       	mov    $0x7ad,%ebx
        while(*s != 0){
